...
#define SLD_DUMMY 0x111
#define DEV_NAME "sld,dummy_sysc_catapult"
...
int main(int argc, char * argv[])
{
	...
	for (n = 0; n < ndev; n++) {
...
#else
		{
			...
			/* <<--regs-config-->> */
		iowrite32(dev, DUMMY_MAC_N_REG, mac_n);
		iowrite32(dev, DUMMY_MAC_VEC_REG, mac_vec);
		iowrite32(dev, DUMMY_MAC_LEN_REG, mac_len);
