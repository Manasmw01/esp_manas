...
solution file add "../inc/dummy_data_types.hpp"
solution file add "../../../common/inc/esp_dma_info_sysc.hpp"
solution file add "../inc/dummy_conf_info.hpp"
solution file add "../inc/dummy.hpp"
solution file add "../src/dummy.cpp"
solution file add "../inc/dummy_specs.hpp"
solution file add "../inc/mem_wrap.hpp"

solution file set ../inc/dummy_specs.hpp -args -DDMA_WIDTH=$DMA_WIDTH
