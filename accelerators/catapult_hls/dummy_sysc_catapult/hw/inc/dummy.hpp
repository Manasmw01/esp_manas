...
#include "dummy_data_types.hpp"
#include "dummy_specs.hpp"
#include "dummy_conf_info.hpp"

#define __round_mask(x, y) ((y)-1)
#define round_up(x, y) ((((x)-1) | __round_mask(x, y))+1)

SC_MODULE(dummy_sysc_catapult)
{
public:
  ...
  SC_CTOR(dummy_sysc_catapult):  plm_in_ping("plm_in_ping"), plm_in_pong("plm_in_pong"), plm_out_ping("plm_out_ping"), plm_out_pong("plm_out_pong"){
