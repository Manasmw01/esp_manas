...
void dummy_sysc_catapult:: config() {
    conf_info.Reset();
    conf1.ResetWrite();
    conf2.ResetWrite();
    conf2b.ResetWrite();
...
void dummy_sysc_catapult::compute_dataReq() {
...
void dummy_sysc_catapult:: compute() {
...
void dummy_sysc_catapult:: store_dataReq() {
...
void dummy_sysc_catapult:: store() {
