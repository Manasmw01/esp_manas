...
solution file add "../inc/kalman_data_types.hpp"
solution file add "../../../common/inc/esp_dma_info_sysc.hpp"
solution file add "../inc/kalman_conf_info.hpp"
solution file add "../inc/kalman.hpp"
solution file add "../src/kalman.cpp"
solution file add "../inc/kalman_specs.hpp"
solution file add "../inc/mem_wrap.hpp"

solution file set ../inc/kalman_specs.hpp -args -DDMA_WIDTH=$DMA_WIDTH
