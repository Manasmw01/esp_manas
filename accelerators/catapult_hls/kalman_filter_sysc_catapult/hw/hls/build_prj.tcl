...
solution file add "../src/kalman_filter.cpp"
solution file add "../inc/kalman_filter_specs.hpp"
solution file add "../inc/mem_wrap.hpp"

solution file set ../inc/kalman_filter_specs.hpp -args -DDMA_WIDTH=$DMA_WIDTH
